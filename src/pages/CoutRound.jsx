...
export default function CoutRound() {
  ...
  return (
    ...
    >
      <div
        className={`flex ${isLandscape ? "flex-row" : "flex-col"} items-center justify-center gap-12`}
      >
        {/* Nút giảm */}
        <button
          onClick={onDecrease}
        ...
        {/* Vùng hiển thị chữ “ROUND” + số */}
        <div className="flex flex-col items-center">
          <h2 className="text-white text-4xl sm:text-5xl font-bold tracking-widest mb-2 drop-shadow-md uppercase">
            ROUND
          </h2>
